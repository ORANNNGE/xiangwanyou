			...
			$("#value").focus();
			 validateForm = $("#inputForm").validate({
				submitHandler: function(form){
					jp.loading();
					$.post("${ctx}/sys/foreDict/save",$('#inputForm').serialize(),function(data){
		                    if(data.success){
...
<body class="bg-white">
	<form:form id="inputForm" modelAttribute="dictType" action="${ctx}/sys/foreDict/save" method="post" class="form-horizontal">
		<form:hidden path="id"/>
