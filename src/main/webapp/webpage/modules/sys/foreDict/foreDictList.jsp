...
<body>
	...
	<div class="row">
			...
			<!-- 工具栏 -->
		    <div id="toolbar">
		    	<shiro:hasPermission name="sys:foreDict:add">
		    ...
		    <div  id="right" class="panel panel-default col-sm-6" style="display:none">
				<div class="panel-heading">
					<%--<h3 class="panel-title"><label>键值列表，所属类型: </label><font id="dictTypeLabel"></font>--%>
					<input type="hidden" id="dictTypeId"/></h3>
				</div>
				<div class="panel-body">
				 <div id="dictValueToolbar">
					<button id="dictValueButton"  class="btn btn-outline btn-primary" title="添加分组"><i class="fa fa-plus-circle"></i> 添加分组</button>
				</div>
				 <!-- 表格 -->
