 ...
 */
@Controller
@RequestMapping(value = "${adminPath}/sys/foreDict")
public class ForeDictController extends BaseController {
	...
	@RequiresPermissions("sys:foreDict:list")
	@RequestMapping(value = {"list", ""})
	public String list() {
		return "modules/sys/foreDict/foreDictList";
	}
	...
	@RequiresPermissions(value={"sys:foreDict:view","sys:foreDict:add","sys:foreDict:edit"},logical=Logical.OR)
	@RequestMapping(value = "form")
	public String form(DictType dictType, Model model) {
		model.addAttribute("dictType", dictType);
		return "modules/sys/foreDict/foreDictForm";
	}
	...
	public String dictValueForm(String dictValueId, String dictTypeId, Model model) {
		...
		return "modules/sys/foreDict/foreDictValueForm";
	}


	@ResponseBody
	@RequiresPermissions(value={"sys:foreDict:add","sys:foreDict:edit"},logical=Logical.OR)
	...
	@ResponseBody
	@RequiresPermissions("sys:foreDict:edit")
	...
	@ResponseBody
	@RequiresPermissions("sys:foreDict:del")
